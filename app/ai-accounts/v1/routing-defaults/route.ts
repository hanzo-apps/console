 ...
 * `/cloud` proxy. It deliberately does NOT touch the org-settings WRITE path: a
...
/** The unified cloud backend (hanzoai/cloud) — same in-cluster target as the `/cloud` proxy. */
