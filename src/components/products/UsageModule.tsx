...
import { BarChart, Donut, CHART_PALETTE, CHART_OTHER, type ChartPoint, type Slice } from '@hanzo/ui/product'
import { MetricCard, Panel, LegendDot } from '@hanzo/ui/product'
