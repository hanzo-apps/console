...
/**
 * CodeSamples — the interactive Quick Start / code block. Tab-switch between the REAL
 * API call in curl / Python / TS / JS, copy the current sample, and (optionally) Run /
 * Try in Playground. Not a screenshot — real, copyable, tab-switchable code. The block
 * scrolls horizontally inside its own container so a wide line never scrolls the page.
 */
          ...
          {samples.map((s, i) => {
            ...
            return (
              <Button
                ...
                borderWidth={1}
                borderColor={on ? '$color7' : '$borderColor'}
                onPress={() => setActive(i)}
              >
