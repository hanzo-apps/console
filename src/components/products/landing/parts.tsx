...
/**
 * ProductLanding UI atoms — the shared card / action-row / delta-chip language, in the
 * same dark-card idiom as the inference dashboard (the design target). Strictly
 * @hanzo/gui v5 shorthands.
 */
