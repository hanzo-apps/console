...
vi.mock('@hanzogui/lucide-icons-2', () => {
  const names = ['Activity', 'Building2', 'Cpu', 'CreditCard', 'DollarSign', 'FunctionSquare', 'Gauge', 'Hash', 'Layers', 'Percent', 'PiggyBank', 'Receipt', 'Timer', 'TrendingUp', 'TriangleAlert', 'Users']
