 ...
 * tab). This is the ONE task→model-pool + cost-ceiling editor; `RouterModule`
 * embeds it as a sub-section (never a second copy).
 *
...
export function RouterPolicyEditor(_props: { params: Record<string, string> }) {
  ...
  return (
    <>
      <PageHeader
        title="Router policy"
        subtitle="Configure your org's task pools and cost ceiling — the router folds org > “*” > platform default per task."
        actions={
