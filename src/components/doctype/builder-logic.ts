 ...
 */
import type { DocType, DocField, Fieldtype } from '~/lib/framework/types'
import { slugify, isValidDoctypeName } from '~/lib/framework/fields'
...
export function starterFields(): BuilderField[] {
  return [
    ...
    // Optional project scope — lets the org→project switcher filter this collection.
