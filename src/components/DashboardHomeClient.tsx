 ...
 *
 * This is the client body of the dashboard home. `app/(dashboard)/page.tsx` loads
 * it via `dynamic(ssr:false)` so the GUI/registry tree (react-native-web) is NEVER
 * evaluated during the static-export prerender — the export emits only the shell
 * and this renders on the client (see next.config.mjs / webui.go).
 */
