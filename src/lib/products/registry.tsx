...
export const visibleCatalogByCategory = (
  ...
  // In billing-only (or ads-only) mode the single product is the whole catalog —
  // surface it as a single group regardless of the brand's category order (its
  // category may be outside the brand's normal set).
  if (config.billingOnly || config.adsOnly) {
