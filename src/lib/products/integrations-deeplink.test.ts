...
describe('integrations deep link', () => {
  it('declares the :provider sub-route in the shipped registry', () => {
    ...
    expect(routes).toContain("{ path: '', component: OrgIntegrationsModule }")
    expect(routes).toContain("{ path: ':provider', component: OrgIntegrationsModule }")
  })
