...
/**
 * The org's subscription plans (rpm/tpm/quota tiers) — the subscription LADDER, which is
 * a different question from the cloud tier catalog the bare `/v1/plan` answers. Honest-empty
 * (`[]`) when the surface is gated/not-routed
