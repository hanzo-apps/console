 ...
 *   PUT    /v1/commerce/plans/entries/:slug — update (slug IMMUTABLE — the handler rejects
 *                                             a body slug ≠ path slug with 400)
 ...
 * the standalone `app/v1/commerce/[...path]` user-bearer proxy → commerce; on the go:embed
