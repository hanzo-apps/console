 ...
 * and the /v1/billing/me/welcome proxy — do not exist; their POSTs fall through to the
 * GET-only SPA fallback and 405. The console runs on the casibase session there (the
