 ...
 */
export type ShellId = 'console' | 'billing' | 'marketing' | 'ads' | 'social' | 'sentry' | 'dns' | 'tracker'
...
export function shellFromHost(host?: string | null): ShellId {
  ...
  if (env === 'billing' || env === 'marketing' || env === 'ads' || env === 'social' || env === 'sentry' || env === 'dns' || env === 'tracker' || env === 'console') return env
