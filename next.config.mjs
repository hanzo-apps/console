 ...
 */
const CLOUD_V1_HEADS = ['prompts', 'agents', 'evals', 'analytics', 'usage', 'audit', 'templates', 'projects', 'platform', 'crm', 'tracker', 'integrations', 'ml', 'vpcs', 'load-balancers', 'networks', 'mesh', 'edge', 'indexers', 'oracles', 'authz', 'o11y', 'websearch', 'enablement']
