 ...
 */
const CLOUD_V1_HEADS = ['prompts', 'agents', 'evals', 'analytics', 'usage', 'audit', 'templates', 'projects', 'platform', 'crm', 'referrals', 'affiliates', 'authors', 'finance', 'tracker', 'integrations', 'ml', 'vpcs', 'load-balancers', 'networks', 'mesh', 'edge', 'indexers', 'oracles', 'authz', 'o11y', 'websearch', 'enablement']
...
const ADMIN_V1_HEADS = ['overview', 'usage', 'orgs', 'audit', 'products', 'finance', 'compute', 'o11y', 'providers', 'customers', 'revenue', 'analytics', 'enablement', 'grants', 'referrals', 'affiliates', 'authors', 'treasury']
/**
