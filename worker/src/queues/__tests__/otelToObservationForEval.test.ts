...
describe("OTEL to ObservationForEval Schema Validation", () => {
  ...
  describe("Hanzo SDK spans", () => {
    it("should convert a Hanzo SDK generation span to valid ObservationForEval", async () => {
      const hanzoOtelSpan = {
        resource: {
          attributes: [
            ...
            spans: [
              {
                ...
                attributes: [
                  ...
                  {
                    key: "hanzo.observation.metadata.custom_key",
    ...
    it("should convert a Hanzo SDK span with minimal attributes", async () => {
      const minimalOtelSpan = {
        resource: { attributes: [] },
        scopeSpans: [
          {
            scope: { name: "hanzo-sdk", version: "3.0.0" },
            spans: [
              {
    ...
    it("should correctly map all ObservationForEval fields", async () => {
      ...
      const fullOtelSpan = {
        resource: {
          attributes: [
            { key: "telemetry.sdk.language", value: { stringValue: "python" } },
            { key: "hanzo.environment", value: { stringValue: "staging" } },
            { key: "hanzo.release", value: { stringValue: "v2.0.0" } },
            {
              key: "service.name",
        ...
        scopeSpans: [
          {
            scope: { name: "hanzo-sdk", version: "3.5.0" },
            spans: [
              {
                ...
                attributes: [
                  ...
                  {
                    key: "hanzo.observation.metadata.request_id",
                    value: { stringValue: '"req-12345"' },
                  },
                  {
                    key: "hanzo.observation.metadata.source",
            ...
            spans: [
              {
                ...
                attributes: [
                  ...
                  {
                    key: "hanzo.experiment.id",
                    value: { stringValue: "exp-001" },
                  },
                  {
                    key: "hanzo.experiment.name",
                    value: { stringValue: "Prompt Optimization v2" },
                  },
                  {
                    key: "hanzo.experiment.description",
                    value: { stringValue: "Testing new prompt templates" },
                  },
                  {
                    key: "hanzo.experiment.dataset.id",
                    value: { stringValue: "dataset-test-001" },
                  },
                  {
                    key: "hanzo.experiment.item.id",
                    value: { stringValue: "item-123" },
                  },
                  {
                    key: "hanzo.experiment.item.expected_output",
            ...
            spans: [
              {
                ...
                attributes: [
                  ...
                  {
                    key: "hanzo.observation.metadata",
                    value: {
                      stringValue: JSON.stringify({
                        nested: {
                          deeply: {
