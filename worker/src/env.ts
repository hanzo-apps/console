...
const EnvSchema = z.object({
  ...
  S3_BATCH_EXPORT_ENABLED: z.enum(["true", "false"]).default("false"),
  S3_BATCH_EXPORT_BUCKET: z.string().optional(),
  S3_BATCH_EXPORT_PREFIX: z.string().default(""),
  S3_BATCH_EXPORT_REGION: z.string().optional(),
  S3_BATCH_EXPORT_ENDPOINT: z.string().optional(),
  S3_BATCH_EXPORT_EXTERNAL_ENDPOINT: z.string().optional(),
  S3_BATCH_EXPORT_ACCESS_KEY_ID: z.string().optional(),
  S3_BATCH_EXPORT_SECRET_ACCESS_KEY: z.string().optional(),
  S3_BATCH_EXPORT_FORCE_PATH_STYLE: z.enum(["true", "false"]).default("false"),
  S3_BATCH_EXPORT_SSE: z.enum(["AES256", "aws:kms"]).optional(),
  S3_BATCH_EXPORT_SSE_KMS_KEY_ID: z.string().optional(),

  S3_EVENT_UPLOAD_BUCKET: z.string({
    error: "Hanzo requires a bucket name for S3 Event Uploads.",
  }),
  S3_EVENT_UPLOAD_PREFIX: z.string().default(""),
  S3_EVENT_UPLOAD_REGION: z.string().optional(),
  S3_EVENT_UPLOAD_ENDPOINT: z.string().optional(),
  S3_EVENT_UPLOAD_ACCESS_KEY_ID: z.string().optional(),
  S3_EVENT_UPLOAD_SECRET_ACCESS_KEY: z.string().optional(),
  S3_EVENT_UPLOAD_FORCE_PATH_STYLE: z.enum(["true", "false"]).default("false"),
  S3_EVENT_UPLOAD_SSE: z.enum(["AES256", "aws:kms"]).optional(),
  S3_EVENT_UPLOAD_SSE_KMS_KEY_ID: z.string().optional(),
  ...
  BATCH_EXPORT_DOWNLOAD_LINK_EXPIRATION_HOURS: z.coerce.number().positive().default(24),
  ...
  HANZO_MAX_HISTORIC_EVAL_CREATION_LIMIT: z.coerce.number().positive().default(50_000),
  EMAIL_FROM_ADDRESS: z.string().optional(),
  SMTP_CONNECTION_URL: z.string().optional(),
  CLOUD_CRM_EMAIL: z.string().optional(),
  HANZO_OTEL_INGESTION_QUEUE_PROCESSING_CONCURRENCY: z.coerce.number().positive().default(5),
  ...
  HANZO_EVAL_CREATOR_LIMITER_DURATION: z.coerce.number().positive().default(500),
  HANZO_EVAL_CREATOR_WORKER_CONCURRENCY: z.coerce.number().positive().default(2),
  HANZO_TRACE_UPSERT_WORKER_CONCURRENCY: z.coerce.number().positive().default(25),
  HANZO_TRACE_DELETE_CONCURRENCY: z.coerce.number().positive().default(1),
  HANZO_SCORE_DELETE_CONCURRENCY: z.coerce.number().positive().default(1),
  HANZO_DATASET_DELETE_CONCURRENCY: z.coerce.number().positive().default(1),
  ...
  HANZO_ENABLE_REDIS_SEEN_EVENT_CACHE: z.enum(["true", "false"]).default("false"),
  ...
  QUEUE_CONSUMER_CLOUD_USAGE_METERING_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_CLOUD_SPEND_ALERT_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_FREE_TIER_USAGE_THRESHOLD_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  ...
  QUEUE_CONSUMER_BATCH_ACTION_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_EVAL_EXECUTION_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_TRACE_UPSERT_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_CREATE_EVAL_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_TRACE_DELETE_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_SCORE_DELETE_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_DATASET_DELETE_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  ...
  QUEUE_CONSUMER_INGESTION_SECONDARY_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_DATA_RETENTION_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_DEAD_LETTER_RETRY_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("false"),
  QUEUE_CONSUMER_WEBHOOK_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_ENTITY_CHANGE_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),
  QUEUE_CONSUMER_EVENT_PROPAGATION_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("false"),
  QUEUE_CONSUMER_NOTIFICATION_QUEUE_IS_ENABLED: z.enum(["true", "false"]).default("true"),

  HANZO_EVENT_PROPAGATION_WORKER_GLOBAL_CONCURRENCY: z.coerce.number().positive().default(10),
  HANZO_DATASET_RUN_BACKFILL_CHUNK_SIZE: z.coerce.number().positive().default(200),
  HANZO_EXPERIMENT_BACKFILL_THROTTLE_MS: z.coerce
    .number()
    .positive()
    .default(5 * 60 * 1000), // 5 minutes

  // Core data S3 upload - Hanzo Cloud
  S3_CORE_DATA_EXPORT_IS_ENABLED: z.enum(["true", "false"]).default("false"),
  S3_CORE_DATA_UPLOAD_BUCKET: z.string().optional(),
  S3_CORE_DATA_UPLOAD_PREFIX: z.string().default(""),
  S3_CORE_DATA_UPLOAD_REGION: z.string().optional(),
  S3_CORE_DATA_UPLOAD_ENDPOINT: z.string().optional(),
  S3_CORE_DATA_UPLOAD_ACCESS_KEY_ID: z.string().optional(),
  S3_CORE_DATA_UPLOAD_SECRET_ACCESS_KEY: z.string().optional(),
  S3_CORE_DATA_UPLOAD_FORCE_PATH_STYLE: z.enum(["true", "false"]).default("false"),
  S3_CORE_DATA_UPLOAD_SSE: z.enum(["AES256", "aws:kms"]).optional(),
  S3_CORE_DATA_UPLOAD_SSE_KMS_KEY_ID: z.string().optional(),
  ...
  S3_MEDIA_UPLOAD_FORCE_PATH_STYLE: z.enum(["true", "false"]).default("false"),
  S3_MEDIA_UPLOAD_SSE: z.enum(["AES256", "aws:kms"]).optional(),
  S3_MEDIA_UPLOAD_SSE_KMS_KEY_ID: z.string().optional(),

  // Metering data Postgres export - Hanzo Cloud
  ...
  HANZO_BATCH_PROJECT_CLEANER_CHECK_INTERVAL_MS: z.coerce.number().positive().default(600_000), // 10 minutes between checks after successful processing
  HANZO_BATCH_PROJECT_CLEANER_SLEEP_ON_EMPTY_MS: z.coerce.number().positive().default(3_600_000), // 1 hour sleep when there is no data to process
  ...
  HANZO_MEDIA_RETENTION_CLEANER_ITEM_LIMIT: z.coerce.number().positive().default(10_000), // Max items (media files) to process per batch

  // Batch Trace Deletion Cleaner configuration
  HANZO_BATCH_TRACE_DELETION_CLEANER_ENABLED: z.enum(["true", "false"]).default("false"),
  HANZO_BATCH_TRACE_DELETION_CLEANER_INTERVAL_MS: z.coerce.number().positive().default(600_000), // 10 minutes between runs
  HANZO_BATCH_TRACE_DELETION_CLEANER_LOCK_TTL_SECONDS: z.coerce.number().positive().default(7200), // 2 hours to handle worst-case deletions

  HANZO_EXPERIMENT_BACKFILL_EXCLUDE_ATTRIBUTES_KEY: z.enum(["true", "false"]).default("false"),

  // Deprecated. Do not use!
  HANZO_EXPERIMENT_RETURN_NEW_RESULT: z.enum(["true", "false"]).default("false"),
  HANZO_EXPERIMENT_INSERT_INTO_EVENTS_TABLE: z.enum(["true", "false"]).default("false"),
  HANZO_EXPERIMENT_EARLY_EXIT_EVENT_BATCH_JOB: z.enum(["true", "false"]).default("false"),
  HANZO_EXPERIMENT_EVENT_PROPAGATION_PARTITION_DELAY_MINUTES: z.coerce.number().positive().int().default(10),

  HANZO_WEBHOOK_QUEUE_PROCESSING_CONCURRENCY: z.coerce.number().positive().default(5),
  HANZO_WEBHOOK_TIMEOUT_MS: z.coerce.number().positive().default(10000),
  HANZO_WEBHOOK_MAX_REDIRECTS: z.coerce.number().positive().default(10),
  HANZO_ENTITY_CHANGE_QUEUE_PROCESSING_CONCURRENCY: z.coerce.number().positive().default(2),
  HANZO_DELETE_BATCH_SIZE: z.coerce.number().positive().default(2000),
  HANZO_TOKEN_COUNT_WORKER_POOL_SIZE: z.coerce.number().positive().default(2),
});
