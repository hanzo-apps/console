...
export class MediaRetentionCleaner extends PeriodicExclusiveRunner {
  protected get defaultIntervalMs(): number {
    return env.HANZO_MEDIA_RETENTION_CLEANER_INTERVAL_MS;
  }
  ...
  public override start(): void {
    logger.info(`Starting ${this.instanceName}`, {
      intervalMs: env.HANZO_MEDIA_RETENTION_CLEANER_INTERVAL_MS,
      itemLimit: env.HANZO_MEDIA_RETENTION_CLEANER_ITEM_LIMIT,
    });
    super.start();
  }
