...
export type DatasetRunItemDomain<WithIO extends boolean = true> = WithIO extends true
  ? z.infer<typeof DatasetRunItemSchema>
  : Omit<
      z.infer<typeof DatasetRunItemSchema>,
      "datasetRunMetadata" | "datasetItemInput" | "datasetItemExpectedOutput" | "datasetItemMetadata"
    >;
