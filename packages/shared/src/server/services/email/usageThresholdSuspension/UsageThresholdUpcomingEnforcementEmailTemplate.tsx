        ...
        <Body className="bg-background my-auto mx-auto font-sans">
          <Container className="mx-auto my-10 w-[465px] rounded border border-solid border-[#eaeaea] p-5">
            <Section className="mt-8">
              <Img
                src="https://static.hanzo.ai/hanzo_logo_transactional_email.png"
                width="40"
                height="40"
                alt="Hanzo"
            ...
            <Section>
              ...
              <Text className="text-gray-700 text-sm leading-6">
                ...
                <strong>{limit.toLocaleString()} event limit</strong> for the free tier.
              </Text>
              <Text className="text-gray-700 text-sm leading-6 font-semibold">
                Beginning next week, we will begin enforcing usage limits. Based on your current usage, your account
                would be suspended and ingestion would stop.
              </Text>
            </Section>

            <Section className="mt-8">
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 text-center">
                <Text className="text-orange-600 text-sm font-medium m-0 mb-1">Current Usage</Text>
                <Text className="text-3xl font-bold text-orange-700 m-0">{currentUsage.toLocaleString()}</Text>
            ...
            <Section className="mt-8">
              <Heading className="text-black text-[18px] font-semibold">What happens beginning next week?</Heading>
              <Text className="text-gray-700 text-sm leading-6">
                If you remain on the free tier and exceed the limit:
                <br />
                <br />• <strong>New traces, observations, and scores cannot be ingested</strong>
                <br />
            ...
            <Section className="mt-8">
              <Heading className="text-black text-[18px] font-semibold">How to avoid service disruption:</Heading>
              <Text className="text-gray-700 text-sm leading-6">
                • <strong>Upgrade to a paid plan now to ensure uninterrupted operations</strong>
                <br />• Wait until your usage limit resets on <strong>{formattedResetDate}</strong> (though you may
                exceed it again)
            ...
            <Section>
              <Text className="text-[#666666] text-[12px] leading-[24px]">
                This important notification was sent to {receiverEmail} regarding upcoming usage enforcement for &quot;
                {organizationName}&quot;.
              </Text>
              <Text className="text-[#666666] text-[12px] leading-[24px]">
