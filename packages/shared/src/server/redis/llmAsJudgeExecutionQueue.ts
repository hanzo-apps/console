...
export class LLMAsJudgeExecutionQueue {
  private static instance: Queue<TQueueJobTypes[QueueName.LLMAsJudgeExecution]> | null = null;

  public static getInstance(): Queue<TQueueJobTypes[QueueName.LLMAsJudgeExecution]> | null {
    if (LLMAsJudgeExecutionQueue.instance) return LLMAsJudgeExecutionQueue.instance;
    ...
    LLMAsJudgeExecutionQueue.instance = newRedis
      ? new Queue<TQueueJobTypes[QueueName.LLMAsJudgeExecution]>(QueueName.LLMAsJudgeExecution, {
          connection: newRedis,
