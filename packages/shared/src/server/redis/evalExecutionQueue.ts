...
export class EvalExecutionQueue {
  ...
  public static getInstance(): Queue<TQueueJobTypes[QueueName.EvaluationExecution]> | null {
    ...
    EvalExecutionQueue.instance = newRedis
      ? new Queue<TQueueJobTypes[QueueName.EvaluationExecution]>(QueueName.EvaluationExecution, {
          connection: newRedis,
