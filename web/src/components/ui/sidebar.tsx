    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper flex min-h-screen-with-banner w-full text-sidebar-foreground has-[[data-variant=inset]]:bg-sidebar",
            className,
          )}
          ref={ref}
          {...props}
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "relative h-screen-with-banner w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear",
      ...
      <div
        className={cn(
          "fixed bottom-0 top-banner-offset z-20 hidden h-screen-with-banner w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
  return (
    <div ref={ref} data-sidebar="header" className={cn("flex min-h-11 flex-col pt-2 md:h-fit", className)} {...props} />
  );
});
...
const SidebarFooter = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2", "group-data-[collapsible=icon]:p-2", className)}
      {...props}
    />
  );
});
...
const SidebarSeparator = React.forwardRef<React.ElementRef<typeof Separator>, React.ComponentProps<typeof Separator>>(
  ({ className, ...props }, ref) => {
    return (
      <Separator ref={ref} data-sidebar="separator" className={cn("w-auto bg-sidebar-border", className)} {...props} />
    );
  },
);
...
const SidebarMenuSub = React.forwardRef<HTMLUListElement, React.ComponentProps<"ul">>(
  ({ className, ...props }, ref) => (
    <ul
      ...
      className={cn(
        "flex min-w-0 translate-x-px flex-col border-sidebar-border py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className,
      )}
      {...props}
