...
import { SessionBadge, UserIdBadge } from "../TraceDetailView/TraceMetadataBadges";
    ...
    <div className="flex-shrink-0 space-y-2 border-b p-2 @container">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-wrap items-center gap-1">
          <LocalIsoDate date={observation.startTime} accuracy="millisecond" className="text-sm" />
        </div>
        ...
        <div className="flex flex-wrap items-center gap-1">
          ...
          {observation.promptId && <PromptBadge promptId={observation.promptId} projectId={projectId} />}
        </div>
      </div>
    </div>
  );
