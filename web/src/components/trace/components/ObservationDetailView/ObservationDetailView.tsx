...
export function ObservationDetailView({
  ...
  const { comments, serverScores: scores, corrections, roots } = useTraceData();

  // Is this observation topmost in the tree? Uses the tree's roots array
  // (handles orphans correctly). Controls whether trace-level tags are shown.
