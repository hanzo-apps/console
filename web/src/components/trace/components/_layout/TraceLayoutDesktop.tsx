...
TraceLayoutDesktop.ResizeHandle = function ResizeHandle() {
  ...
  return (
    <Separator
      ...
      className="bg-border after:bg-primary relative w-px transition-colors duration-200 after:absolute after:inset-y-0 after:left-0 after:w-1 after:opacity-0 after:transition-opacity after:duration-200 hover:after:opacity-100 active:after:opacity-100"
