...
const PageHeader = ({
  ...
  return (
    <div
      className={cn([
        "top-banner-offset bg-background sticky z-30 w-full border-b shadow-sm",
        className,
      ])}
      id="page-header"
    >
              ...
              >
                {tabsProps.tabs.map((tab) => (
                  <Link
                    ...
                    className={cn(
                      "hover:bg-muted/50 focus-visible:ring-ring inline-flex h-full items-center justify-center rounded-none border-b-4 border-transparent px-2 py-0.5 text-sm font-medium whitespace-nowrap transition-all focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none",
