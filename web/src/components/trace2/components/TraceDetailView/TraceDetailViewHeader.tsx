...
export const TraceDetailViewHeader = memo(function TraceDetailViewHeader({
  ...
  return (
    <div className="@container flex-shrink-0 space-y-2 border-b p-2">
      ...
      <div className="grid w-full grid-cols-1 items-start gap-2 @2xl:grid-cols-[auto,auto] @2xl:justify-between">
        <div className="flex w-full flex-row items-start gap-1">
          ...
          <span className="mb-0 ml-1 line-clamp-2 min-w-0 font-medium break-all md:break-normal md:break-words">
            {trace.name || trace.id}
          </span>
