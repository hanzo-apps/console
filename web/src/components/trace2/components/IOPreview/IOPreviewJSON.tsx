...
function IOPreviewJSONInner({
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col border-t border-b">
      ...
      <div className="bg-background flex h-9 flex-shrink-0 items-center gap-1.5 border-b px-2">
      ...
      <div className="bg-background flex h-6 flex-shrink-0 items-center gap-1.5 border-b px-2">
