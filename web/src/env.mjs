...
export const env = createEnv({
  ...
  server: {
    ...
    HANZO_API_TRACES_DEFAULT_DATE_RANGE_DAYS: z.coerce
      .number()
      .int()
      .positive()
      .optional(),
    HANZO_API_TRACES_REJECT_NO_DATE_RANGE: z
      .enum(["true", "false"])
      .default("false"),
    HANZO_API_TRACES_DEFAULT_FIELDS: z.string().optional(),
  ...
  runtimeEnv: {
    ...
    IAM_SERVER_URL: process.env.IAM_SERVER_URL,
    ...
    HANZO_API_TRACES_DEFAULT_DATE_RANGE_DAYS:
      process.env.HANZO_API_TRACES_DEFAULT_DATE_RANGE_DAYS,
    HANZO_API_TRACES_REJECT_NO_DATE_RANGE:
      process.env.HANZO_API_TRACES_REJECT_NO_DATE_RANGE,
    HANZO_API_TRACES_DEFAULT_FIELDS:
      process.env.HANZO_API_TRACES_DEFAULT_FIELDS,
    // Events table migration
  ...
  // Skip validation in Docker builds or frontend-only dev mode
  // DOCKER_BUILD is set in Dockerfile, SKIP_ENV_VALIDATION for local frontend dev
  skipValidation:
