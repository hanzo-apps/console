...
export const BillingScheduleNotification = () => {
  ...
  if (cancellation) {
    return (
      <div className="border-border bg-muted text-foreground mt-6 mb-4 flex overflow-x-auto rounded-lg border py-2 text-sm contrast-more:border-current ltr:pr-4 rtl:pl-4">
