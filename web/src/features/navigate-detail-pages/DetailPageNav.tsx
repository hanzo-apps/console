        ...
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              ...
              <span className="ml-1 h-4 w-4 rounded-sm bg-primary/80 text-xs text-primary-foreground shadow-sm">K</span>
            </Button>
          </TooltipTrigger>
          <TooltipContent>
            <span>Navigate up</span>
            <InputCommandShortcut className="ml-2 rounded-sm bg-muted p-1 px-2">k</InputCommandShortcut>
          </TooltipContent>
        </Tooltip>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              ...
              <span className="ml-1 h-4 w-4 rounded-sm bg-primary/80 text-xs text-primary-foreground shadow-sm">J</span>
            </Button>
          </TooltipTrigger>
          <TooltipContent>
            <span>Navigate down</span>
            <InputCommandShortcut className="ml-2 rounded-sm bg-muted p-1 px-2">j</InputCommandShortcut>
          </TooltipContent>
        </Tooltip>
      </div>
    );
