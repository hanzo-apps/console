...
const organizationSizeOptions = ["1-10", "10-49", "50-99", "100-299", "More than 300"] as const;

const organizationName = StringNoHTML.min(3, "Must have at least 3 characters").max(
  60,
