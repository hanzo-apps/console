import {
  ...
  StatusAnnouncer,
  useAccessibility,
} from "@/src/features/agents/components/AccessibilityEnhancements";
import { DIDInfoModal } from "@/src/features/agents/components/did/DIDInfoModal";
import { EnvironmentVariableForm } from "@/src/features/agents/components/forms/EnvironmentVariableForm";
import {
  MCPServerControls,
  MCPServerList,
  MCPToolExplorer,
  MCPToolTester,
} from "@/src/features/agents/components/mcp";
import { ReasonersSkillsTable } from "@/src/features/agents/components/ReasonersSkillsTable";
import { StatusRefreshButton } from "@/src/features/agents/components/status";
import {
  AgentControlButton,
  type AgentState,
...
import { NotificationProvider } from "@/src/features/agents/components/ui/notification";
import { RestartRequiredBanner } from "@/src/features/agents/components/ui/RestartRequiredBanner";
import { Skeleton } from "@/src/features/agents/components/ui/skeleton";
import {
  AnimatedTabs,
  AnimatedTabsContent,
  AnimatedTabsList,
  AnimatedTabsTrigger,
} from "@/src/features/agents/components/ui/animated-tabs";
...
} from "@/src/features/agents/components/ui/notification";
...
import { useLocation, useNavigate, useParams } from "../adapters";
import { EnhancedNodeDetailHeader } from "@/src/features/agents/components/nodes";
import { getNodeStatusPresentation } from "@/src/features/agents/utils/node-status";
