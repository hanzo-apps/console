...
import { SlackService } from "@hanzo/console/src/server";
      ...
      try {
        ...
        const testBlocks = [
          ...
          },
          {
            ...
            text: {
              type: "mrkdwn",
              text: "Hello from Hanzo! This is a test message to verify your Slack integration is working properly.",
            },
          },
          {
            type: "section",
