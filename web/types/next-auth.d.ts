...
declare module "next-auth" {
  interface Session extends DefaultSession {
    ...
    environment: {
      ...
      // Enables features that are only available under an enterprise/commercial license when self-hosting Hanzo
  ...
  interface User extends DefaultUser {
    ...
    canCreateOrganizations: boolean; // default true, allowlist can be set via HANZO_ALLOWED_ORGANIZATION_CREATORS
    organizations: {
